# constants
# Time
FOUNTAIN_MONTHS = 'FOUNTAIN:MONTHS'
FOUNTAIN_WEEKDAYS = 'FOUNTAIN:WEEKDAYS'
FOUNTAIN_HOLIDAYS = 'FOUNTAIN:HOLIDAYS'
FOUNTAIN_MONTH_DAYS = 'FOUNTAIN:MONTH_DAYS'
...
FOUNTAIN_BUILTIN = {FOUNTAIN_MONTHS, FOUNTAIN_WEEKDAYS, FOUNTAIN_HOLIDAYS, FOUNTAIN_MONTH_DAYS}

RESOURCES = {
    FOUNTAIN_MONTHS: "months.csv",
    FOUNTAIN_WEEKDAYS: "weekdays.csv",
    FOUNTAIN_HOLIDAYS: "holidays.csv",
    FOUNTAIN_MONTH_DAYS: "month_days.csv"
}